          ...
          <div className="space-y-8 mr-4">
            ...
            <SettingSection title="Profile">
              <SettingCard>
                <div className="space-y-4">
                  ...
                  <input
                    type="text"
                    defaultValue={localStorage.getItem("pecinhas:user") || ""}
                    onChange={(e) => localStorage.setItem("pecinhas:user", e.target.value)}
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        localStorage.setItem("pecinhas:user", username)
            ...
            <SettingSection title="About">
              <SettingCard>
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-base font-medium text-sparkle-text mb-1">Pecinhas</h3>
                    <p className="text-sm text-sparkle-text-secondary">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-sparkle-text-secondary">
                      © {new Date().getFullYear()} PecinhasFPS
                    </p>
                  </div>
                </div>
              </SettingCard>
